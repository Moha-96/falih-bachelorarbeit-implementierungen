(ns de.hhu.anemic.warenkorb.application.ApplicationService
  (:require [de.hhu.anemic.warenkorb.domain.model.anzahl.Anzahl :as anzahl]
            [de.hhu.anemic.warenkorb.domain.model.artikel.ArtikelRepository :as artikel-repository]
            [de.hhu.anemic.warenkorb.domain.model.preis.Preis :as preis]
            [de.hhu.anemic.warenkorb.domain.model.warenkorb.Warenkorb :as warenkorb]
            [de.hhu.anemic.warenkorb.domain.model.warenkorb.WarenkorbRepository :as warenkorb-repository]))

(defn erstelle-warenkorb-fuer-kunde [kunde-id preis]
  (let [max-einkaufswert (preis/erstelle-preis preis "EUR")
        warenkorb (warenkorb/erstelle-neuen-warenkorb kunde-id max-einkaufswert)]
